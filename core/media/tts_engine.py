...
# ─────────────────────────────────────────────────────────────
from core.providers.speech.tts.base import TTSProvider, TTSResult  # noqa: F401

# Re-export constants (used by external code)
from core.providers.speech.tts.edge import EDGE_VOICE_PRESETS  # noqa: F401
from core.providers.speech.tts.minimax import EMOTION_TO_MINIMAX  # noqa: F401
...
class TTSEngine:
    ...
    def _get_provider(self, provider_name: str):
        ...
        if provider_name not in self._providers:
            from core.providers.registry import get_tts
