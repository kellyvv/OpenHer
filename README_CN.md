...
OpenHer 支持多种大模型——但不是所有模型都能胜任人格涌现。让 AI 保持角色一致、表达有层次的情感、不泄漏内部格式，这对模型来说很*难*。

**选择建议：**

- 🥇 **Claude Haiku 4.5** — 综合最强。角色最*真*。零格式泄漏。
- 🥈 **Gemini Flash Lite** — 质量接近 Claude，价格更低。很好的默认选择。
- 🇨🇳 **Qwen3（通义千问）** — 国内用户最佳选择，无需翻墙。
