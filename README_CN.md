...
- [x] 风格记忆 — 会结晶、会消退的体验（Hebbian 学习 + Hawking 辐射衰减）
...
- [ ] **了解你的全部** — 日历、消息记录（微信 · iMessage · Telegram）、位置、浏览轨迹——她拼出一个真实的你，而不只是你描述的那个你
- [ ] **环境模式感知** — 你的深夜工作习惯、常去的地方、最常联系的人——她读懂你自己都没意识到的信号
- [ ] 移动端（iOS / Android）
- [ ] 多角色社交层 — 角色之间互相认识，对你形成不同的看法

### 阶段 Ⅲ · **同在** — *走进你的世界* 🌌

*她变得真实。声音、视觉、空间——以及一段随岁月深化的关系。*
