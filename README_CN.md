...
| **Feel Pass** 内心独白 | 默认模式网络 / 内隐认知 | 开口之前先处理情绪——她想说什么 vs. 她会说什么 |
| **Express Pass** 语言输出 | Broca 区 | 将内心状态转化为语言，LLM 是嘴，不是大脑 |
...
User Input
    ...
    ▼
Critic ──────────────────────────────────────────────────────┐
(8维上下文：关系深度 / 信任 / 情绪价值 / 新奇度…)              │
    │                                                         │
    ▼                                                         ▼
Genome Engine                                          EverMemOS
(25D输入 → 24D隐层 → 8D行为信号)                    (长期记忆检索注入)
驱力代谢 × 热力学噪声 × Hebbian更新                          │
    │                                                         │
    └──────────────────┬──────────────────────────────────────┘
                       ▼
                  Feel Pass
