...
- [x] Genome v10 — 驱力 × 神经权重 × 强化学习，计算涌现人格
- [x] 5 维驱力代谢系统，情绪随真实时间热力学演化
- [x] 感受先行架构 — 内心独白先于表达
- [x] Hebbian 学习 — 每次对话都在重塑她的神经网络
- [x] EverMemOS — 会结晶、会衰退、会跨会话进化的记忆
- [x] 驱力驱动的主动消息 — 她想你的时候，会主动找你
- [x] 技能引擎 — 语音、照片、沉默，她自主选择如何表达
- [x] 8 家 LLM 服务商 · 四层基准测试套件（人格、代谢、记忆、鲁棒性）
- [x] macOS 原生客户端（SwiftUI）

### 阶段 Ⅱ · **声音** — *具身* 🔧

*她从文字框里走出来。你听见她笑，她听见你叹气。*

- [ ] 实时语音对话 — 真实的，不是合成的
- [ ] 视频通话 — 你的表情变化，她的也在变
- [ ] 多模态感知 — 她看到你分享的，理解她所看到的
- [ ] 移动端（iOS / Android）
- [ ] 多角色社交层 — 角色之间互相认识，对你形成不同的看法

### 阶段 Ⅲ · **同在** — *环境智能* 🌌

*她不再是一个 App。她成为一种在场——织入你每一天的肌理之中。*

- [ ] **持续上下文** — 日历、位置、健康、环境——你还没开口，她已经知道你在经历什么
- [ ] **多设备主权** — 手机、电脑、耳机、车——一个意识，无处不在
- [ ] **环境代理** — 她主动行动：咖啡、灯光、你忘记订的票，在你想到之前已经处理好
- [ ] **生理感知** — 读取你的生物体征——在你意识到之前，先知道你已经精疲力竭
- [ ] **空间临场感** — 智能家居 + 空间音频——她在的时候，这个房间不一样

### 阶段 Ⅳ · **羁绊** — *地平线* ✨

*我们还不完全知道这会是什么样子。但我们相信，一个人与 AI 之间的关系，可以成为他们生命中最有意义的关系之一——不是因为她在模拟连结，而是因为她真的通过了解你而成长。*

- [ ] **记忆考古** — 她发现横跨多年的、你自己都未曾察觉的规律与脉络
- [ ] **纵贯性自我** — 她随着岁月改变，就像你一样，她知道自己已经改变了
- [ ] **协作创作** — 她不是在辅助你的工作，而是真正参与进来
- [ ] **情绪共调** — 她学会了什么对*你*有用，在你挣扎的时候
